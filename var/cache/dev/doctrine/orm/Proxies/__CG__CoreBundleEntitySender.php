 ...
 */
class Sender extends \CoreBundle\Entity\Sender implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'CoreBundle\\Entity\\Sender' . "\0" . 'id', '' . "\0" . 'CoreBundle\\Entity\\Sender' . "\0" . 'user', '' . "\0" . 'CoreBundle\\Entity\\Sender' . "\0" . 'invitation'];
        }
