 ...
 */
class Receiver extends \CoreBundle\Entity\Receiver implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'CoreBundle\\Entity\\Receiver' . "\0" . 'id', '' . "\0" . 'CoreBundle\\Entity\\Receiver' . "\0" . 'user', '' . "\0" . 'CoreBundle\\Entity\\Receiver' . "\0" . 'invitation'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Receiver $proxy) {
