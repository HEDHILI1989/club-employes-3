...
class User extends \CoreBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'CoreBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'CoreBundle\\Entity\\User' . "\0" . 'firstName', '' . "\0" . 'CoreBundle\\Entity\\User' . "\0" . 'lastName', '' . "\0" . 'CoreBundle\\Entity\\User' . "\0" . 'email', '' . "\0" . 'CoreBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'CoreBundle\\Entity\\User' . "\0" . 'token', '' . "\0" . 'CoreBundle\\Entity\\User' . "\0" . 'sender', '' . "\0" . 'CoreBundle\\Entity\\User' . "\0" . 'receiver'];
        }
    ...
    public function addReceiver(\CoreBundle\Entity\Receiver $receiver)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addReceiver', [$receiver]);

        return parent::addReceiver($receiver);
    }
    ...
    public function removeReceiver(\CoreBundle\Entity\Receiver $receiver)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeReceiver', [$receiver]);

        return parent::removeReceiver($receiver);
    }
